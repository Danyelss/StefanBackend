 ...
 *     description: Only admins can create other machines.
 *     tags: [machines]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *     description: Only admins can retrieve all machines.
 *     tags: [machines]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in machines can fetch only their own machine information. Only admins can fetch other machines.
 *     tags: [machines]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in machines can only update their own information. Only admins can update other machines.
 *     tags: [machines]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in machines can delete only themselves. Only admins can delete other machines.
 *     tags: [machines]
 *     security:
 *       - bearerAuth: []
 *     parameters:
